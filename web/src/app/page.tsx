...
import nlwLogo from '../assets/nlw_spacetime_logo.svg'

export default function Home() {
  return (
    <main className="grid grid-cols-2 min-h-screen">
      {/* Left */}
      <div className="relative flex flex-col items-start justify-between overflow-hidden px-28 py-16 border-r border-r-gray-50/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
        {/* blut */}
        <div className="absolute right-0 top-1/2 h-[288px] w-[526px] -translate-y-1/2 translate-x-1/2 rounded-full bg-purple-700 opacity-50 overflow-hidden blur-full"></div>
        ...
        <div className='space-y-5'>
          ...
          <div className='max-w-[420px] space-y-1'>
            ...
            <p className='text-lg leading-relaxed'>Colecione momentos marcantes da sua jornada e compartilhe (se quise) com o mundo!</p>
          </div>
